...
3. [planned] Surface de-chrome — strip neon glows, heavy drop-shadows, inset-gloss, backdrop-blur; flatten card hover to border-only; keep hairline borders + flat panel fills + brand colors. spec:03-dechrome-spec.md plan:03-dechrome-plan.md wt:.worktrees/03-dechrome mimo:dechrome-5d2c
