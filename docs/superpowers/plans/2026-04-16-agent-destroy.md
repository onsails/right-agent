...
Run: `cd /Users/molt/dev/rightclaw && cargo test -p rightclaw --lib agent::destroy::tests -- --nocapture`
...
Run: `cd /Users/molt/dev/rightclaw && cargo test -p rightclaw-cli --test cli_integration -- --nocapture`
...
Run: `cd /Users/molt/dev/rightclaw && cargo clippy --workspace -- -D warnings`
Expected: no warnings

- [ ] **Step 4: Manual smoke test**

Run: `cd /Users/molt/dev/rightclaw && cargo run -- agent --help`
