...
- [x] **Phase 8: HOME Isolation & Permission Model** - Per-agent HOME override with credential forwarding, explicit permissions replacing bypass mode (completed 2026-03-24)
- [x] **Phase 9: Agent Environment Setup** - Pre-populate complete agent environment: git init, Telegram channel copy, full .claude/ scaffold (completed 2026-03-24)
...
| 8. HOME Isolation & Permission Model | v2.1 | 2/2 | Complete | 2026-03-24 |
| 9. Agent Environment Setup | v2.1 | 2/2 | Complete | 2026-03-24 |
