...
reproduction: rm -rf ~/.rightclaw && cargo run --release --bin rightclaw -- init --telegram-token TOKEN --telegram-user-id 12345678 && cargo run --release --bin rightclaw -- up --debug
