...
- [x] 27-02-PLAN.md — MCP server rename to 'rightclaw' + cron_list_runs + cron_show_run tools
...
Plans:
- [x] 30-01-PLAN.md — Add rg PATH check (DOC-01) and settings.json ripgrep.command validation (DOC-02) to doctor
