...
- 📋 **v3.4 Chrome Integration** - Phases 42-44 (in progress)
...
### 📋 v3.4 Chrome Integration (In Progress)
...
- [x] **Phase 43: Init Detection + Up Revalidation** - Auto-detect Chrome at init, --chrome-path override, revalidate on every up
...
**Plans**: 2 plans
Plans:
- [x] 43-01-PLAN.md — Chrome + MCP detection helpers, --chrome-path arg, cmd_init() single-write refactor
- [x] 43-02-PLAN.md — cmd_up() per-run Chrome path revalidation
...
| 43. Init Detection + Up Revalidation | v3.4 | 2/2 | Complete | 2026-04-06 |
