...
**Goal**: Close tech debt from v2.2 audit before milestone completion: fix `requirements-completed` frontmatter in two SUMMARY.md files, and add `.claude/skills/skills/` stale dir cleanup to `cmd_up` (the skills/ → rightskills/ rename parallel to SKILLS-05 clawhub cleanup)
**Depends on**: Phase 14
