...
**Goal:** Wire `chrome-devtools-mcp` into rightclaw as a built-in browser MCP — auto-detected at init, injected into every agent's `.mcp.json` and sandbox settings, validated by doctor and bot startup, and surfaced in AGENTS.md system prompt templates.
...
**Progress:**
- [x] Phase 42: Chrome Config Infrastructure + MCP Injection (completed 2026-04-06)
- [x] Phase 43: Init Detection + Up Revalidation (completed 2026-04-06)
- [ ] Phase 44: Validation + AGENTS.md Template (not started)
