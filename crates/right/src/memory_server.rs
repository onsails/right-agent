...
impl MemoryServer {
    ...
    async fn cron_create(
                ...
                right_agent::cron_skill_link::link_agent(&conn, &params.job_name, skills).await
        {
            ...
            if let Err(de) =
                right_agent::cron_spec::delete_spec(&conn, &params.job_name, &self.agent_dir).await
            {
