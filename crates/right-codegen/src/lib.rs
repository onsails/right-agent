...
pub use agent_def::{
    ...
    CRON_SCHEMA_JSON, CURATOR_PLAN_SCHEMA, CURATOR_REPORT_PROMPT, CURATOR_SYSTEM_PROMPT,
    OPERATING_INSTRUCTIONS, PROBE_WRITER_ANCHOR_TEMPLATE, PROBE_WRITER_INSTRUCTIONS,
